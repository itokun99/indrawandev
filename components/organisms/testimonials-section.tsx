    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">What Others Say</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="relative overflow-hidden">
            <CardContent className="p-8 md:p-12">
              ...
              <blockquote className="text-lg md:text-xl leading-relaxed mb-8 text-muted-foreground">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-dashed">
                <img
                  ...
                  className="w-16 h-16 rounded-full object-cover border-2 border-dashed"
                />
                <div>
                  <div className="font-semibold text-foreground font-mono">{currentTestimonial.author}</div>
                  <div className="text-sm text-muted-foreground font-mono">{currentTestimonial.title}</div>
                </div>
              </div>
            </CardContent>
          </Card>
