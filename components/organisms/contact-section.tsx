          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Have a project in mind or just want to say hi? Feel free to reach out. I'm always interested in
                discussing new opportunities and innovative projects.
              </p>

              <div className="flex items-center gap-3 text-muted-foreground">
                <Mail className="h-5 w-5 text-primary" />
                <a href="mailto:ito@byito.dev" className="hover:text-primary transition-colors">
                  ito@byito.dev
                </a>
              </div>
            </div>
